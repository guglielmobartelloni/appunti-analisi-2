...
Il vettore $n \in \mathbb{R}^{n}$ e' una n-pla $x=(x_1,x_2,...,x_n)$
...
\begin{itemize}
    ...
    \item prodotto scalare
        ...
        \[
            <x,y> = x\cdot y := \sum^{n}_{i=1} x_i y_i
        \]

        L'operazione quindi va $<,>: \mathbb{R}^{n} \times \mathbb{R}^{n} \rightarrow \mathbb{R}$
        ...
        \begin{enumerate}
            \item \textbf{Bilinearita'} (lineare su ogni fattore):
                ...
                \[
                    (\alpha x_1 + \beta x_2) \bullet y = <(\alpha x_1 + \beta x_2), y> = \alpha <x_1,y>+ \beta<x_2,y> = \alpha x_1 \bullet y + \beta x_2 \bullet y
                \]
            ...
            \item \textbf{Positivita'} 
                ...
                \[
                    x \bullet x = <x,x> = \sum^{n}_{i=1} x_i^{2}\ge 0
                \]

                \[
                    x \bullet x = <x,x> = 0 \Leftrightarrow x = 0 = (0,...,0)\ \text{vettore nullo}
                \]
...
\begin{proof}
       \[
           |x+ y| ^{2} = < x+y , x+y> = (x+y) \bullet (x+y) \overset{\text{bilinearita'}}{=} <x,x+y> + <y,x+y> \overset{\text{sempre bilinearita'}}{=} 
       \]    
...
Altra cosa interessante:
 ...
 \teorema{Disuguaglianza di Cauchy-Schwarz}{
     ...
     \[
         x\bullet y = |x| |y|  \Leftrightarrow y = 0 \text{ oppure } x=\lambda y \text{ con } \lambda \in \mathbb{R}\ge 0
     \]
 ...
 \begin{proof}
     ...
     \[
         |x + ty| ^{2} \overset{\text{Carnot}}{=} |x|^{2} + |ty|^{2} + 2<x,ty>  = |x|^{2} + |y|^{2}t^{2} + 2 <x,y> t
     \]
 ...
 ed anche la disugualgianza triangolare:

 \[
     |x+y| \le |x|+|y|
 \]
   
se $|x+y| = |x| + |y|$ allora $y =0$ oppure $x= \lambda y $ con $\lambda \ge 0$:

\begin{proof}
       Dimostriamo la disuguaglianza triangolare, considero:

       \[
           |x+y|^{2} = <x+y , x+y> = |x|^{2}+|y|^{2} + 2<x,y> \le 
       \]

       \[
           \le |x|^{2} + |y| ^{2} + 2|<x,y>| \le \underbrace{|x| ^{2} + |y|^{2} + 2|x|\bullet |y|}_{(|x|+|y|)^{2}}
       \]
