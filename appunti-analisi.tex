...
Se non è nullo, il gradiente di una funzione differenziabile in un punto indica la direzione e il verso di \textbf{massima pendenza}  del grafico di $f$ nel putno. E dunque se considero la derivata direzionale di $f$ (nel punto) nella direzione del vettore gradiente trovo il valore della massima pendenza, che è appunto la lunghezza del vettore gradiente $|\nabla f(x_0)|$:
