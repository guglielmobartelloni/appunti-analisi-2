...
Dove le fuznioni f e g sono continue nei loro domini di definizione

Determinare gli eventuali zeri(valori di $\bar y$ tra cui $g(\bar y) = 0$) voglio diviedere per g per separare le variabili

considerando $y != \bar y$ si separano le variabili dividendi per $g(y)$
