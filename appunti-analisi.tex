...
Determinare gli eventuali zeri(valori di $\bar y$ tra cui $g(\bar y) = 0$) voglio dividere per g per separare le variabili

considerando $y \neq \bar y$ si separano le variabili dividendi per $g(y)$
